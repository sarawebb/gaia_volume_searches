    ...
    for line in df:
        if len(line)>0:
            ...
            if len(line_split)>=25:
                ra.append(float(line_split[4]))
                print(line_split[4])
                dec.append(float(line_split[6]))
...
filename1 = '/home/swebb/oz100/NOAO_archive/archive_NOAO_data/scripts/create_lc/total_field_sources/fields/2016_07_14hr_full_field_sources.ascii'
filename2 = '/home/swebb/oz100/NOAO_archive/archive_NOAO_data/scripts/GAIA_volume_searchs/100pc/14hrfield.100pc.sample'

ra1, dec1 = np.loadtxt(filename1, skiprows=1, unpack = True)
ra, dec = getstars(filename2)
print(ra, dec)
